...
const app = new MapApp({
  ...
  title: {
    ...
    subtitle:
      "Patrimoine mondial de l'UNESCO \u2014 Paysage culturel \u00e9volutif vivant, inscrit en 2012",
  },
  baseLayers: {
    IGN: {
      ...
      thumbnailUrl:
        'https://data.geopf.fr/wmts?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=GEOGRAPHICALGRIDSYSTEMS.PLANIGNV2&STYLE=normal&FORMAT=image/png&TILEMATRIXSET=PM&TILEMATRIX=10&TILEROW=345&TILECOL=520',
    },
    Clair: {
    ...
    Satellite: {
      ...
      thumbnailUrl:
        'https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/10/345/520',
    },
  },
